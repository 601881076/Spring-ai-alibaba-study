...
public class PromptController {
    ...
    public Flux<String> chat(String question) { // AI 能力边界
        return deepseekChatClient.prompt().system("你是一个法律助手，只回答法律问题，其它问题回复，我只能回答法律相关问题，其它无可奉告").user(question).stream().content();
    }

    /**
     * http://localhost:8005/prompt/chat2?question=葫芦娃     * @param question     * @return
     */
    ...
    /**
     * http://localhost:8005/prompt/chat3?question=葫芦娃     * @param question     * @return
     */
    ...
    /**
     * http://localhost:8005/prompt/chat4?question=葫芦娃     * @param question     * @return
     */
    ...
    /**
     * http://localhost:8005/prompt/chat5?city=北京     * 近似理解Tool后面章节讲解......     * @param city     * @return
     */
